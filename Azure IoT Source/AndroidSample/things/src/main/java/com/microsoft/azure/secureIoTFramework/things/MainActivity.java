package com.microsoft.azure.secureIoTFramework.things;
...
import com.microsoft.azure.secureIoTFramework.things.R;
...
public class MainActivity extends Activity {
    ...
    {
        client = new DeviceClient(connString, protocol2);
