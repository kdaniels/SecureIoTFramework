...
public class ReadDeviceToCloudMessages {
  ...
  private static final String EVENT_HUBS_COMPATIBLE_ENDPOINT = "sb://ihsuproddbres045dednamespace.servicebus.windows.net/";

  // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
  private static final String EVENT_HUBS_COMPATIBLE_PATH = "iothub-ehub-908306hub-4344955-671c41e6b7";

  // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
  private static final String IOT_HUB_SAS_KEY = "RyMhHaCrT1vLgiH11HX73pCrW4h/BwZ4BUoVdRJEtTw=";
