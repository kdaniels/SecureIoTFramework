...
public class SimulatedDevice {
  ...
  private static String connString = "HostName=908306Hub.azure-devices.net;DeviceId=MyJavaDevice;SharedAccessKey=VsDHhJ/zKEyW9cd+QYDdXLwVkcV5w7Kx5HmN9yHJkFA=";

  // Using the MQTT protocol to connect to IoT Hub
  // Can use customm protocol to connect to IoT Hub
